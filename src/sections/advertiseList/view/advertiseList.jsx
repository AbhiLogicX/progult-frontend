...
export default function BannerListView() {
  ...
  async function fetchRowData() {
    const result = await getReq('master/advertise');
  ...
  const handleSubmit = async (titleName, selectedFile, descriptionTopic) => {
    ...
    const result = await postReq('master/advertise', formData); // we have to handle the success and error
